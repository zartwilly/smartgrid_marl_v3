...
#_________       all BF, NH ALGOs N instances MULTI_PROCESS : debut         __________ 
def execute_BF_NH_algos_used_Generated_instances_N_INSTANCES_MULTI(arr_pl_M_T_vars_init,
                                            name_dir=None,
                                            date_hhmm=None,
                                            k_steps=None,
                                            NB_REPEAT_K_MAX=None,
    ...
    for (algo_name, (pi_hp_plus_elt, pi_hp_minus_elt), 
        ...
        if algo_name == fct_aux.ALGO_NAMES_LRIx[0]:
            ...
            dico_best_profils_NH, dico_bad_profils_NH, dico_mid_profils_NH \
               = bfNhGameModel.BF_NASH_balanced_player_game(
    ...
    print("NB_EXECUTION cpt={}".format(cpt))
#_________       all BF, NH ALGOs N instances MULTI_PROCESS : fin       ______________ 
