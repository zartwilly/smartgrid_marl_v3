...
def compute_prices_inside_SG_LRIx(arr_pl_M_T_K_vars_modif, t, k,
...
def balanced_player_game_t(arr_pl_M_T_K_vars_modif, t, k, 
    ...
    b0_t_k, c0_t_k, \
    bens_t_k, csts_t_k \
        = compute_prices_inside_SG_LRIx(arr_pl_M_T_K_vars_modif, t, k,
                                         pi_hp_plus, pi_hp_minus, 
                                         a, b,
                                         pi_0_plus_t, pi_0_minus_t, 
                                         manual_debug, dbg)
...
def lri_balanced_player_game_all_pijk_upper_08(arr_pl_M_T_vars_init,
    ...
    B_is_MT, C_is_MT \
        = compute_prices_B_C_BB_CC_EB_LRI(arr_pl_M_T_K_vars_modif, 
                                          dico_k_stop_learnings,
                                          pi_sg_minus_T, pi_sg_plus_T, 
                                          pi_0_minus_T, pi_0_plus_T,
                                          b0_s_T_K, c0_s_T_K)
    ...
    dbg=True
    if dbg:
        checkout_prices_B_C_BB_CC_EB_LRI(arr_pl_M_T_K_vars_modif, 
                                        dico_k_stop_learnings,
                                        path_to_save)
...
def compute_prices_B_C_BB_CC_EB_LRI(arr_pl_M_T_K_vars_modif, 
                                    dico_k_stop_learnings,
                                    pi_sg_minus_T, pi_sg_plus_T, 
                                    pi_0_minus_T, pi_0_plus_T,
                                    b0_s_T_K, c0_s_T_K):
...
def checkout_prices_B_C_BB_CC_EB_LRI(arr_pl_M_T_K_vars_modif, 
                                    dico_k_stop_learnings,
                                    path_to_save):
...
def test_lri_balanced_player_game_all_pijk_upper_08_Pi_Ci_scenario123():
    # steps of learning
    k_steps = 100 #250 # 5,250
    t_periods = 3 #4
    p_i_j_ks = [0.5, 0.5, 0.5]
    ...
    gamma_version = 5 #4 #2 #1 #3: gamma_i_min #4: square_root
    ...
    k_stop_learning_LRIx, bool_equilibrium_nash_LRIx, \
    Perf_sum_Vi_LRIx = lri_balanced_player_game_all_pijk_upper_08(
                                arr_pl_M_T_vars_init,
                                pi_hp_plus=pi_hp_plus, 
                                pi_hp_minus=pi_hp_minus,
                                a=a, b=b,
...
if __name__ == "__main__":
    ...
    k_stop_learning_LRIx, bool_equilibrium_nash_LRIx, \
    Perf_sum_Vi_LRIx  \
        = test_lri_balanced_player_game_all_pijk_upper_08_Pi_Ci_scenario123()
